...
delete require.cache[require.resolve('./modules/verify.ts')];
...
let msgModule = require('./modules/chatFilter');
let utilModule = require('./modules/utils');
const verify = require('./modules/verify.ts');
let adminModule = require('./modules/admin');
let musicController = require('./modules/music');
...
client.on('message', async msg => {
    ...
    if (args[0][0] == config['CommandPrefix']) {
...
function reload(moduleName, msg) {
    ...
    switch (moduleName.toLowerCase()) {
        ...
        case 'admin':
            ...
            adminModule = require('./modules/admin.js');
            msg.channel.send('Reload complete');
            break;
        case 'util':
        case 'utils':
